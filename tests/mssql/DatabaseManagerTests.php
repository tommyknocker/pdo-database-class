...
/**
 * DatabaseManager tests for MSSQL.
 *
...
final class DatabaseManagerTests extends BaseMSSQLTestCase
{
    ...
    public function testDatabaseExists(): void
    {
        ...
        try {
            ...
            if (str_contains($e->getMessage(), 'permission') || str_contains($e->getMessage(), 'privilege')) {
    ...
    public function testListDatabases(): void
    {
        ...
        try {
            ...
            // Should have at least one database (the test database or master)
    ...
    public function testGetDatabaseInfo(): void
    {
        ...
        try {
            ...
            $this->assertEquals('sqlsrv', $info['driver']);
