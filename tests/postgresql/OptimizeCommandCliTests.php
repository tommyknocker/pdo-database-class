...
final class OptimizeCommandCliTests extends BasePostgreSQLTestCase
{
    ...
    public function testOptimizeAnalyzeCommand(): void
    {
        ...
        // Create test tables
        $db->rawQuery('CREATE TABLE IF NOT EXISTS optimize_users (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testOptimizeQueryCommand(): void
    {
        ...
        $db->rawQuery('CREATE TABLE optimize_query_users (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testOptimizeAnalyzeWithFormatOptions(): void
    {
        ...
        $db->rawQuery('CREATE TABLE test_format (id SERIAL PRIMARY KEY)');
    ...
    public function testSchemaAnalyzerClass(): void
    {
        ...
        $db->rawQuery('CREATE TABLE test_users_schema (id SERIAL PRIMARY KEY, name VARCHAR(100))');
...
');
    ...
    public function testSchemaAnalyzerDetectsMissingFkIndexes(): void
    {
        ...
        $db->rawQuery('CREATE TABLE test_parent (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testSchemaAnalyzerStatistics(): void
    {
        ...
        $db->rawQuery('CREATE TABLE stats_table1 (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testSchemaAnalyzerIndexSuggestionsForForeignKeys(): void
    {
        ...
        $db->rawQuery('CREATE TABLE fk_parent (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testSchemaAnalyzerLargeTableWarning(): void
    {
        ...
        $db->rawQuery('CREATE TABLE large_table_test (id SERIAL PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testDatabaseConfigOptimizerClass(): void
    {
        ...
        $this->assertIsArray($result);
        $this->assertEquals('pgsql', $result['dialect']);
        $this->assertNotEmpty($result['recommendations'], 'Should have recommendations');
        $this->assertArrayHasKey('shared_buffers', $result['recommendations']);
    }
}
