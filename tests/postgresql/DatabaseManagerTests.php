...
/**
 * DatabaseManager tests for PostgreSQL.
 *
...
final class DatabaseManagerTests extends BasePostgreSQLTestCase
{
    ...
    protected function checkPrivileges(): void
    {
        try {
            ...
            if (str_contains($message, 'permission denied') || str_contains($message, 'privilege') || str_contains($message, 'denied')) {
    ...
    public function testDatabaseExists(): void
    {
        ...
        try {
            ...
            if (str_contains($e->getMessage(), 'permission denied') || str_contains($e->getMessage(), 'privilege')) {
    ...
    public function testListDatabases(): void
    {
        ...
        try {
            ...
            // Should have at least one database (the test database or postgres)
    ...
    public function testGetDatabaseInfo(): void
    {
        ...
        try {
            ...
            $this->assertEquals('pgsql', $info['driver']);
