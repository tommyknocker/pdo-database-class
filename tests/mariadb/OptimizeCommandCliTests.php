...
final class OptimizeCommandCliTests extends BaseMariaDBTestCase
{
...
');
    ...
    public function testSchemaAnalyzerDetectsMissingFkIndexes(): void
    {
        ...
        $db->rawQuery('CREATE TABLE test_parent (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100))');
    ...
    public function testDatabaseConfigOptimizerClass(): void
    {
        ...
        $this->assertIsArray($result);
        $this->assertEquals('mariadb', $result['dialect']);
