...
/**
 * MariaDB-specific tests for INSERT ... SELECT functionality.
 */
final class InsertFromTests extends BaseMariaDBTestCase
{
    ...
    public function testInsertFromWithOnDuplicate(): void
    {
        ...
        // MariaDB uses ON DUPLICATE KEY UPDATE - need to specify columns
