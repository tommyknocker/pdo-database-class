...
/**
 * SchemaIntrospectionTests tests for mariadb.
 */
final class SchemaIntrospectionTests extends BaseMariaDBTestCase
{
    ...
    public function testDescribeUsers(): void
    {
        ...
        // MariaDB returns 'int(11)' instead of 'int'
        $this->assertMatchesRegularExpression('/^int(\(11\))?$/i', $idColumn['Type']);
    ...
    public function testDescribeOrders(): void
    {
        ...
        // MariaDB returns 'int(11)' instead of 'int'
        $this->assertMatchesRegularExpression('/^int(\(11\))?$/i', $userIdColumn['Type']);
