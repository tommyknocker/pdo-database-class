...
/**
 * MariaDB-specific DDL Builder tests.
 *
 * These tests verify MariaDB-specific DDL builder methods and SQL generation.
 */
final class MariaDBDdlBuilderTests extends BaseMariaDBTestCase
{
    /**
    ...
    /**
     * Test buildCreateTableSql with MariaDB-specific options (ENGINE, CHARSET, COLLATE).
     */
    ...
    /**
     * Test formatColumnDefinition with MariaDB-specific types.
     */
    ...
    public function testBuildRenameForeignKeySql(): void
    {
        ...
        $this->expectExceptionMessage('MariaDB does not support renaming foreign keys directly');
