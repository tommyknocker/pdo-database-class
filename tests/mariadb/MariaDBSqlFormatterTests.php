...
use tommyknocker\pdodb\dialects\mariadb\MariaDBSqlFormatter;
use tommyknocker\pdodb\helpers\values\RawValue;

/**
 * Tests for MariaDBSqlFormatter.
 */
final class MariaDBSqlFormatterTests extends BaseMariaDBTestCase
{
    private MariaDBSqlFormatter $formatter;
    ...
    public function setUp(): void
    {
        ...
        $this->formatter = new MariaDBSqlFormatter($connection->getDialect());
    }
    ...
    public function testFormatWindowFunction(): void
    {
        ...
        // Test LAG with default value (MariaDB-specific: uses COALESCE)
        $result = $this->formatter->formatWindowFunction(
            'LAG',
            ['value', 1, 'default'],
            [],
        ...
        $this->assertStringContainsString('LAG', $result);

        // Test LEAD with default value (MariaDB-specific: uses COALESCE)
        $result = $this->formatter->formatWindowFunction(
            'LEAD',
            ['value', 1, 0],
            [],
