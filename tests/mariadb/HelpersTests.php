...
/**
 * HelpersTests tests for mariadb.
 */
final class HelpersTests extends BaseMariaDBTestCase
{
    ...
    public function testRegexpHelpers(): void
    {
        ...
        // Note: MariaDB REGEXP_SUBSTR doesn't support capture groups in older versions
