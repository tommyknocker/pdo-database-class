...
/**
 * Misctests for mariadb.
 */
final class MiscTests extends BaseMariaDBTestCase
{
    ...
    public function testMaterializedCteBasic(): void
    {
        ...
        // MariaDB uses optimizer hints, not MATERIALIZED keyword
        // For MariaDB, we just verify the CTE is generated correctly
        $this->assertStringContainsString('high_values', $sqlData['sql']);
    }
